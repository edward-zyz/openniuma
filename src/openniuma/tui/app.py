...
from openniuma.tui.deps import ensure_deps
...
from openniuma.tui.data import (  # noqa: E402
    log_file_path,
    read_log_tail,
    read_state,
    read_stats_for_task,
...
from openniuma.tui.widgets.task_list import TaskListPanel, TaskSelected  # noqa: E402
from openniuma.tui.widgets.task_detail import TaskDetailPanel  # noqa: E402
from openniuma.tui.widgets.log_viewer import LogViewerPanel  # noqa: E402
...
def main() -> None:
    ...
    parser.add_argument("--dir", default=default_dir, help="openniuma 目录路径")
